...
var app, base, concat, directory, gulp, gutil, hostname, path, refresh, less, uglify, imagemin, minifyCSS, del, browserSync, autoprefixer, gulpSequence, shell, sourceMaps, plumber;
...
//compiling our LESS files
gulp.task('styles', function() {
    //the initializer / master LESS file, which will just be a file that imports everything
...
//compiling our LESS files for deployment
gulp.task('styles-deploy', function() {
    //the initializer / master LESS file, which will just be a file that imports everything
    return gulp.src('./app/styles/less/main.less')
        .pipe(plumber())
        //include LESS includes folder
        .pipe(less({
            paths: [
                'app/styles/less',
            ]
